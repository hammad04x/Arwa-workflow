      ...
      <div className="flex shrink-0 items-center justify-between bg-white px-6 py-4 border-b border-grey-border z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-grey-muted mt-0.5">Add a new product to your inventory catalog</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <Button variant="secondary" onClick={handleClose} text="Cancel" />
          <Button variant="primary" type="submit" form="product-add-form" text={isSubmitting ? "Adding..." : "Add product"} disabled={isSubmitting} />
        </div>
      </div>
