  ...
  return (
    <div className="flex flex-col h-[96vh] overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden min-h-0 relative">
        ...
        {step === 2 && (
          <div className="h-full flex flex-col lg:flex-row pb-2 gap-6 animate-in fade-in slide-in-from-right-4 duration-200 min-h-0">
            
            {/* Left: Section Generator Wrapper */}
            <div className="w-full lg:w-[400px] shrink-0 min-h-0 flex flex-col justify-start">
              <div className="w-full min-h-0 shrink bg-white rounded-xl border border-grey-border shadow-sm flex flex-col overflow-hidden">
                <div className="bg-grey-bg/50 px-6 py-4 border-b border-grey-border">
                <h3 className="font-bold text-grey-text-strong flex items-center gap-2">
                  <LayoutGrid size={18} className="text-primary" />
                  Bulk Generate Sections
                </h3>
              </div>
              <div className="overflow-y-auto custom-scrollbar p-6 flex flex-col gap-5 min-h-0">
            ...
            <div className="flex-1 min-h-0 flex flex-col justify-start">
              <div className="w-full min-h-0 shrink bg-white rounded-xl border border-grey-border shadow-sm flex flex-col overflow-hidden">
              <div className="bg-grey-bg/50 px-6 py-4 border-b border-grey-border flex items-center justify-between shrink-0">
                <h3 className="font-bold text-grey-text-strong">Generated Sections ({sections.length})</h3>
                <span className="text-xs text-grey-muted">Edit names below</span>
              </div>
              
              <div className="overflow-y-auto p-6 custom-scrollbar bg-white min-h-0">
                {sections.length === 0 ? (
        ...
        {step === 3 && (
          <div className="h-full flex flex-col lg:flex-row pb-2 gap-6 animate-in fade-in slide-in-from-right-4 duration-200 min-h-0">
            ...
            <div className="w-full lg:w-[350px] shrink-0 min-h-0 flex flex-col justify-start">
              ...
              <div className="overflow-y-auto p-4 custom-scrollbar flex flex-col gap-2 min-h-0">
                {sections.length === 0 ? (
      ...
      {/* Footer Actions */}
      <div className="bg-white px-6 py-4 border-t border-grey-border shrink-0 sticky bottom-0 z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] flex items-center justify-between mt-auto">
        <div>
          <Button variant="secondary" onClick={handleClose} text="Cancel" className="px-6" />
        </div>
